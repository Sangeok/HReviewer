    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold font-mono tracking-tight">Card Component Showcase</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="group">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Perfect for general content containers with clean, minimal styling.
                </p>
              </CardContent>
              <CardFooter>
            ...
            <Card className="group shadow-lg">
              <CardHeader>
                ...
                <CardDescription>Enhanced depth with stronger shadows</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">Ideal for important content that needs visual prominence.</p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="outline">
                  Explore
            ...
            <Card className="group">
              <CardHeader>
                ...
                <CardDescription>Technical aesthetic with subtle glow effect</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  Perfect for highlighting technical features or AI-powered insights.
                </p>
              </CardContent>
              <CardFooter>
            ...
            <Card className="group">
              ...
              <CardContent>
                <p className="text-muted-foreground">Modern glassmorphism design for overlay content.</p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="outline">
                  Preview
            ...
            <Card className="group">
              <CardHeader>
                ...
                <CardDescription>Emphasized border with hover interaction</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">Great for interactive cards that respond to user actions.</p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="outline">
                  Interact
            ...
            <Card className="group">
              <CardHeader>
                ...
                <CardDescription>Transparent with subtle hover effect</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">Minimal visual weight, perfect for secondary content.</p>
              </CardContent>
              <CardFooter>
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="group">
              ...
              <CardContent>
                <p className="text-xs text-muted-foreground">For tight spaces</p>
              </CardContent>
            </Card>
            ...
            <Card className="group">
              ...
              <CardContent>
                <p className="text-muted-foreground">Premium content display</p>
              </CardContent>
            </Card>
          </div>
        </section>
        ...
        {/* Complex Example */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold font-mono">Complex Composition</h2>
          <Card className="group">
            <CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <h4 className="font-semibold font-mono text-sm">Recent Activity</h4>
                <div className="space-y-2">
                  {[
        ...
        {/* Spacing Variants */}
        <section className="space-y-6">
          <h2 className="text-2xl font-semibold font-mono">Spacing Variants</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="group">
              ...
              <CardContent>
                <p className="text-muted-foreground">Minimal space between sections</p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="outline">
                  Action
            ...
            <Card className="group">
              ...
              <CardContent>
                <p className="text-muted-foreground">Balanced space between sections</p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="outline">
                  Action
            ...
            <Card className="group">
              ...
              <CardContent>
                <p className="text-muted-foreground">Ample space between sections</p>
              </CardContent>
              <CardFooter>
                <Button size="sm" variant="outline">
                  Action
